#+title: Ubuntu base docker image for build tcl packages
...
This is [[https://hub.docker.com/_/ubuntu][ubuntu base docker image]] (version 20.04) using [[https://github.com/just-containers/s6-overlay][s6-overlay]] for buid tcl software. The basic idea was taken from [[https://github.com/tcl2020/tcl2020-build][tcl2020-build]] .
...
- [[#code][Code]]
  - [[#version][VERSION]]
  - [[#fossil-settingscrlf-glob][../.fossil-settings/crlf-glob]]
  - [[#fossil-settingscrlf-globno-warn][../.fossil-settings/crlf-glob.no-warn]]
  - [[#fossil-settingsignore-glob][../.fossil-settings/ignore-glob]]
  - [[#fossil-settingsignore-globno-warn][../.fossil-settings/ignore-glob.no-warn]]
  ...
  - [[#buildscommonsh][builds/common.sh]]
  - [[#buildsall-buildsh][builds/all-build.sh]]
  - [[#buildsenv-varssh][builds/env-vars.sh]]
  - [[#buildsns-buildsh][builds/ns-build.sh]]
  - [[#buildsns-downloadsh][builds/ns-download.sh]]
  - [[#buildsns-modules-downloadsh][builds/ns-modules-download.sh]]
  - [[#buildsns-modules-build-nsdbpgsh][builds/ns-modules-build-nsdbpg.sh]]
  - [[#buildsns-modules-build-nsstatssh][builds/ns-modules-build-nsstats.sh]]
  - [[#buildsns-modules-build-nsconfsh][builds/ns-modules-build-nsconf.sh]]
  - [[#buildstcl-buildsh][builds/tcl-build.sh]]
  - [[#buildstcl-downloadsh][builds/tcl-download.sh]]
  - [[#buildstcllib-buildsh][builds/tcllib-build.sh]]
  - [[#buildstcllib-downloadsh][builds/tcllib-download.sh]]
  - [[#buildsthread-buildsh][builds/thread-build.sh]]
  - [[#buildsthread-downloadsh][builds/thread-download.sh]]
  - [[#buildstdom-buildsh][builds/tdom-build.sh]]
  - [[#buildstdom-downloadsh][builds/tdom-download.sh]]
  - [[#buildsxotcl-buildsh][builds/xotcl-build.sh]]
  - [[#buildsxotcl-downloadsh][builds/xotcl-download.sh]]
  - [[#buildsrl_json-buildsh][builds/rl_json-build.sh]]
  - [[#buildsrl_json-downloadsh][builds/rl_json-download.sh]]
...
:END:
 ...
 |----------------+---------+-------------------------------|
 | FOSSIL_VERSION | 2.15.1  | Set upload fossil version     |
 |----------------+---------+-------------------------------|
...
|--------------------+---------+-------------------------------------|
| NS_VERSION         | 4.99.21 | Define NaviServer version           |
|--------------------+---------+-------------------------------------|
| NS_MODULES_VERSION | 4.99.21 | Define NaviServer modules version   |
|--------------------+---------+-------------------------------------|
| RL_JSON_VERSION    |  0.11.0 | Define [[https://github.com/RubyLane/rl_json][RL_JSON]] version              |
|--------------------+---------+-------------------------------------|
| TCL_VERSION        |  8.6.11 | Define tcl version                  |
|--------------------+---------+-------------------------------------|
| TCLLIB_VERSION     |    1.20 | Define tcl lib version              |
|--------------------+---------+-------------------------------------|
| TDOM_VERSION       |   0.9.1 | Define tdom version                 |
|--------------------+---------+-------------------------------------|
| XOTCL_VERSION      |   2.3.0 | Define xotcl version                |
|--------------------+---------+-------------------------------------|
...
: Success
* TODO Improve :noexport:
:PROPERTIES:
:CUSTOM_ID: improve
:END:
1. Docker replace command for add fossil
