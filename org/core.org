...
:END:
 ...
 |----------------+---------+-------------------------------|
 | FOSSIL_VERSION | 2.17    | Set upload fossil version     |
 |----------------+---------+-------------------------------|
...
#+begin_src sh :shebang ""
  # * Versions
  FOSSIL_VERSION="${FOSSIL_VERSION:-2.17}" \
...
#+begin_src sh :shebang ""
  ...
  # * Add
  ADD https://www.fossil-scm.org/home/uv/fossil-linux-x64-2.17.tar.gz /tmp/fossil-linux.tar.gz
