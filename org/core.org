...
This is [[https://hub.docker.com/_/ubuntu][ubuntu base docker image]] (version 22.04) using [[https://github.com/just-containers/s6-overlay][s6-overlay]] for buid tcl software. The basic idea was taken from [[https://github.com/tcl2020/tcl2020-build][tcl2020-build]] .
...
|--------------------+---------+-------------------------------------|
| RL_JSON_VERSION    |  0.12.2 | Define [[https://github.com/RubyLane/rl_json][RL_JSON]] version              |
|--------------------+---------+-------------------------------------|
